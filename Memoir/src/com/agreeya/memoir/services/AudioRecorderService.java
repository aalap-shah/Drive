...
import com.agreeya.memoir.waveaudiorecorder.AudioChunk;
import com.agreeya.memoir.waveaudiorecorder.Complex;
import com.agreeya.memoir.waveaudiorecorder.FFT;
import com.agreeya.memoir.waveaudiorecorder.WavAudioFormat;
import com.agreeya.memoir.waveaudiorecorder.WavFileWriter;

//TODO  : Convert from byte to short for read data from AudioRecorder

/**
 * Service for recording the human conversation
 *
 */
public class AudioRecorderService extends Service {
	...
	public void onCreate() {
		Log.v("service1", "audio recorder created");
		...
		mIntentFFmpeg = new Intent(this.getApplicationContext(),
				FFMpegService.class);
		Toast.makeText(this.getApplicationContext(), "Audio Recorder",
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		Log.v("service1", "audio recorder started");
		if (intent != null) {
			pi = (PendingIntent) intent.getParcelableExtra("response");
			trip = intent.getIntExtra("trip", 599);
		}
	...
	public void onDestroy() {
		...
		Log.v("service1", "Audio Service Destroyed");
	...
	/**
	 * Thread for reading the audio chunks
	 *
	 */
	...
	private class SpeechDetectorRunnable implements Runnable {
		...
		public void saveRecording() {
			try {
				...
				mAudioMp3Path = audioFile + "/audio_" + timeStamp + ".aac";
				...
				Log.v("service1", "audio recorder replying");
				i = new Intent();
				// i.putExtra("test", "YES");
				i.putExtra(TYPE, "audio");
				i.putExtra(LOCATION, mAudioMp3Path);
	...
	/**
	 * Thread for detecting the human voice frequency
	 *
	 */
