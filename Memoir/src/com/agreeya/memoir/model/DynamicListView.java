...
import com.agreeya.memoir.DriveActivity.DriveAdapter;
...
public class DynamicListView extends ListView {
    ...
    public ArrayList<Element> mCheeseList;
...
//        StableArrayAdapter adapter = ((StableArrayAdapter)getAdapter());
        DriveAdapter adapter = ((DriveAdapter)getAdapter());
...
//        StableArrayAdapter adapter = ((StableArrayAdapter)getAdapter());
    ...
    private void swapElements(ArrayList<Element> arrayList, int indexOne, int indexTwo) {
        Element temp = arrayList.get(indexOne);
    ...
    public void setCheeseList(ArrayList<Element> cheeseList) {
